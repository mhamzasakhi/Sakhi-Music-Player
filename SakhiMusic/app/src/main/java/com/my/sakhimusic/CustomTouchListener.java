...
public class CustomTouchListener implements RecyclerView.OnItemTouchListener {
    ...
    private com.my.sakhimusic.onItemClickListener clickListener;

    public CustomTouchListener(Context context, final com.my.sakhimusic.onItemClickListener clickListener) {
